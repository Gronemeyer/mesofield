...
expName = 'Gratings_vis_stim_v0.9'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\2P\\Experiment Types\\Gratings Experiment\\Gratings_vis_stim_v0.9.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # keep track of which components have finished
    Custom_TriggerComponents = [key_resp_2]
